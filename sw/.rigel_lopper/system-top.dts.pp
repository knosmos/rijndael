# 1 "C:\\proj\\rijndael\\sw\\platform\\hw\\sdt\\system-top.dts"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:\\proj\\rijndael\\sw\\platform\\hw\\sdt\\system-top.dts"
/dts-v1/;
# 1 "C:\\proj\\rijndael\\sw\\platform\\hw\\sdt\\zynq-7000.dtsi" 1
# 10 "C:\\proj\\rijndael\\sw\\platform\\hw\\sdt\\zynq-7000.dtsi"
/ {
 #address-cells = <1>;
 #size-cells = <1>;
...
# 3 "C:\\proj\\rijndael\\sw\\platform\\hw\\sdt\\system-top.dts" 2
# 1 "C:\\proj\\rijndael\\sw\\platform\\hw\\sdt\\pl.dtsi" 1
/ {
 amba_pl: amba_pl {
  ranges;
  compatible = "simple-bus";
  #address-cells = <1>;
  #size-cells = <1>;
  firmware-name = "aes_wrapper.bit.bin";
  clocking0: clocking0 {
  ...
  aes_core_0: aes_core@43c00000 {
   xlnx,s00-axi-data-width = <32>;
   compatible = "xlnx,aes-core-1.0";
   status = "okay";
   clock-names = "s00_axi_aclk";
   xlnx,s00-axi-addr-width = <6>;
   xlnx,ip-name = "aes_core";
   xlnx,edk-iptype = "PERIPHERAL";
   reg = <0x43c00000 0x10000>;
   clocks = <&clkc 15>;
   xlnx,name = "aes_core_0";
  };
 };
};
# 4 "C:\\proj\\rijndael\\sw\\platform\\hw\\sdt\\system-top.dts" 2
# 1 "C:\\proj\\rijndael\\sw\\platform\\hw\\sdt\\pcw.dtsi" 1
 &ps7_cortexa9_0 {
...
# 5 "C:\\proj\\rijndael\\sw\\platform\\hw\\sdt\\system-top.dts" 2
/ {
 board = "cora-z7-07s";
 ...
 cpus_a9: cpus-a9@0 {
  ...
  address-map = <0xf0000000 &amba 0xf0000000 0x10000000>,
         ...
         <0x43c00000 &aes_core_0 0x43c00000 0x10000>,

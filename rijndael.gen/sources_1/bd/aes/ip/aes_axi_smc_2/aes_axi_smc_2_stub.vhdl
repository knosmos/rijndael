...
-- Date        : Thu May 28 19:36:06 2026
-- Host        : convolution running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode synth_stub -rename_top aes_axi_smc_2 -prefix
--               aes_axi_smc_2_ aes_axi_smc_2_stub.vhdl
-- Design      : aes_axi_smc_2
...
entity aes_axi_smc_2 is
  ...
  attribute CHECK_LICENSE_TYPE of aes_axi_smc_2 : entity is "aes_axi_smc_2,bd_bc9e,{}";
  attribute CORE_GENERATION_INFO : string;
  attribute CORE_GENERATION_INFO of aes_axi_smc_2 : entity is "aes_axi_smc_2,bd_bc9e,{x_ipProduct=Vivado 2025.1,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=smartconnect,x_ipVersion=1.0,x_ipCoreRevision=27,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of aes_axi_smc_2 : entity is "yes";
end aes_axi_smc_2;

architecture stub of aes_axi_smc_2 is
  ...
  attribute X_INTERFACE_PARAMETER of aclk : signal is "XIL_INTERFACENAME CLK.aclk, FREQ_HZ 50000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN aes_processing_system7_0_0_FCLK_CLK0, ASSOCIATED_BUSIF M00_AXI:S00_AXI, INSERT_VIP 0, ASSOCIATED_CLKEN s_sc_aclken";
  ...
  attribute X_CORE_INFO of stub : architecture is "bd_bc9e,Vivado 2025.1";
begin
end;

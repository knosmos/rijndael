...
#
# Script generated by Vivado on Fri May 29 14:56:44 -0400 2026
...
#
# Usage        : aes.sh
#                aes.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                aes.sh [-reset_run]
#                aes.sh [-reset_log]
#                aes.sh [-help]
#
...
export RDI_DATADIR="F:/Xilinx/2025.1/Vivado/data"
...
# script info
echo -e "aes.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./aes.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb aes.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./aes.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: aes.sh [-help]\n\
Usage: aes.sh [-step]\n\
Usage: aes.sh [-lib_map_path]\n\
Usage: aes.sh [-reset_run]\n\
Usage: aes.sh [-reset_log]\n\
Usage: aes.sh [-keep_index]\n\
Usage: aes.sh [-noclean_files]\n\n\
